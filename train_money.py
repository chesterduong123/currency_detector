...
if __name__ == "__main__":
    ...
    model = YOLO(r"C:\Users\chest\OneDrive\Documents\YOLO26 Stuff\Currency Project\runs\detect\train-30m640r\weights\best.pt")
    model.train(
        data=r"C:\Users\chest\OneDrive\Documents\YOLO26 Stuff\Currency Project\data.yaml",
        epochs=30,           # Train longer, let patience handle the stopping
        # patience=20,
